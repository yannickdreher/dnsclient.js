...
describe('Record type "MD" should be serialized correctly', () => {
    ...
    const serialized   = dnsclient.DnsRecordSerializer.MD.serialize(rdata);
    const deserialized = dnsclient.DnsRecordSerializer.MD.deserialize(new DataView(serialized.buffer), 0);
