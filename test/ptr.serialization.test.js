...
describe('Record type "PTR" should be serialized correctly', () => {
    ...
    const serialized   = dnsclient.DnsRecordSerializer.PTR.serialize(rdata);
    const deserialized = dnsclient.DnsRecordSerializer.PTR.deserialize(new DataView(serialized.buffer), 0);
