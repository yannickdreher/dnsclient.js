...
describe('Record type "DNAME" should be serialized correctly', () => {
    const rdata = { name: "target.example.com" };
    ...
    const serialized   = dnsclient.DnsRecordSerializer.DNAME.serialize(rdata);
    const deserialized = dnsclient.DnsRecordSerializer.DNAME.deserialize(new DataView(serialized.buffer), 0);
